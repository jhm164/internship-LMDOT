...
<div class="row" >
<div class="col-lg-2" style="background-color: #357196;"  >
   ...
   <div class="col-lg-10"  style="background-color: #1e3a68" >
<div> hello</div>
 
  <div class="container-fluid" id="d" >
  <center><span class="fas fa-wallet" style="float: left;font-size: 20px;" > : 4000</span></center>
 <center> <div> <span class="glyphicon glyphicon-user" style="float: right;font-size: 20px;"> <p>Saurabh solkar </p></span>
  </div>
